...
const ADMIN_EMAIL='uncxchamiyaff@gmail.com'.toLowerCase();
...
function initAuth(){
  ...
  onAuthStateChanged(auth,u=>{
    ...
    if(u){
      ...
      setLoginButtonsState(true,name.split(' ')[0],(u.email||'').toLowerCase()===ADMIN_EMAIL);
    }else{
...
// ---------- Admin password gate (client-side lock before showing sign-in/panel) ----------
